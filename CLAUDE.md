...
- **`sw.js`** (raíz, scope `/`) — estrategia mixta:
  ...
  - `CACHE_VERSION = 'sincro-v15'` (al 2026-05-12; bumpeado al retirar el auto-popup del modal en la landing — ahora solo aparece al pulsar CTAs del motor). **Bumpear cada vez que cambien archivos del precache** para que los clientes detecten la nueva versión y purguen la antigua en `activate`. Sin bump, los clientes con SW antiguo siguen sirviendo desde caché y los fixes nunca llegan al usuario.
